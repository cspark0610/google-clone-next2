...
function Header() {
    ...
    return (
        ...
        <div className="flex w-full p-6 items-center">
          ...
          <Avatar
            className="ml-auto"
            url={"https://firebasestorage.googleapis.com/v0/b/juniority-42d4f.appspot.com/o/POST-USER-AVATAR%2Fprofile-photo.jpg?alt=media&token=36a8d097-13dd-4eff-a767-b546690d33fc"}
          />
        </div>
